...
\begin{document}
	...
	\begin{figure}[h!] % 'h!' posiciona la imagen cerca del texto relacionado
		\centering
		\includegraphics[width=0.9\textwidth]{diagrama.pdf} % Ajusta el tamaño con width o height
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.75\textwidth]{grafica_global_debates.pdf} % Cambia el tamaño con width o height
		\vspace{-15mm}
		\caption{Distribución Global de Menciones en Debates}
		\label{fig:globalDebates} % Etiqueta para referencias cruzadas
	\end{figure}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.8\textwidth]{grafica_debate1.pdf} % Cambia el tamaño con width o height
		\vspace{-15mm}
		\caption{Distribución en el primer debate}
		\label{fig:distrDebate1} % Etiqueta para referencias cruzadas
	\end{figure}
	
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.8\textwidth]{grafica_debate2.pdf} % Cambia el tamaño con width o height
		\vspace{-15mm}
		\caption{Distribución en el segundo debate}
		\label{fig:distrDebate2} % Etiqueta para referencias cruzadas
	\end{figure}
	
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.8\textwidth]{grafica_debate3.pdf} % Cambia el tamaño con width o height
		\vspace{-15mm}
		\caption{Distribución en el tercer debate}
		\label{fig:distrDebate3} % Etiqueta para referencias cruzadas
	\end{figure}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.8\textwidth]{grafica_global_x.pdf} % Cambia el tamaño con width o height
		\vspace{-15mm}
		\caption{Distribución Global de Menciones en el Día de la Elección}
		\label{fig:globalDiaEleccion} % Etiqueta para referencias cruzadas
	\end{figure}
	
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.8\textwidth]{grafica_intervalo_8-12.pdf} % Cambia el tamaño con width o height
		\vspace{-15mm}
		\caption{Distribución de Menciones de 08:00 a 12:00}
		\label{fig:xIntervalo812} % Etiqueta para referencias cruzadas
	\end{figure}
	
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.8\textwidth]{grafica_intervalo_12-17.pdf} % Cambia el tamaño con width o height
		\vspace{-15mm}
		\caption{Distribución de Menciones de 12:00 a 17:00}
		\label{fig:xIntervalo1217} % Etiqueta para referencias cruzadas
	\end{figure}

	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.8\textwidth]{grafica_intervalo_17-23.pdf} % Cambia el tamaño con width o height
		\vspace{-15mm}
		\caption{Distribución de Menciones de 17:00 a 23:00}
		\label{fig:xIntervalo1723} % Etiqueta para referencias cruzadas
	\end{figure}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.7\textwidth]{comentarios_fecha.pdf} % Cambia el tamaño con width o height
		\vspace{-3mm}
		\caption{Distribución de Comentarios en los Debates por Fechas}
		\label{fig:temporalDebates} % Etiqueta para referencias cruzadas
	\end{figure}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.7\textwidth]{publicaciones_por_hora.pdf} % Cambia el tamaño con width o height
		\vspace{-3mm}
		\caption{Distribución de Comentarios en los Debates por Fechas}
		\label{fig:temporalDiaEleccion} % Etiqueta para referencias cruzadas
	\end{figure}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=1\textwidth]{nube_palabras_general.pdf} % Cambia el tamaño con width o height
		\vspace{-22mm}
		\caption{Nube de Palabras de los Debates}
		\label{fig:nubeGralDebates} % Etiqueta para referencias cruzadas
	\end{figure}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=1\textwidth]{nube_palabras_debate_1.pdf} % Cambia el tamaño con width o height
		\vspace{-22mm}
		\caption{Nube de Palabras del Primer Debate}
		\label{fig:nubeDebate1} % Etiqueta para referencias cruzadas
	\end{figure}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=1\textwidth]{nube_palabras_debate_2.pdf} % Cambia el tamaño con width o height
		\vspace{-22mm}
		\caption{Nube de Palabras del Segundo Debate}
		\label{fig:nubeDebate2} % Etiqueta para referencias cruzadas
	\end{figure}
	
	\vspace{-10mm}
	\begin{figure}[h!]
		\centering
		\includegraphics[width=1\textwidth]{nube_palabras_debate_3.pdf} % Cambia el tamaño con width o height
		\vspace{-22mm}
		\caption{Nube de Palabras del Tercer Debate}
		\label{fig:nubeDebate3} % Etiqueta para referencias cruzadas
	\end{figure}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=1\textwidth]{nube_general_eleccion.pdf} % Cambia el tamaño con width o height
		\vspace{-22mm}
		\caption{Nube de Palabras del Día de la Elección}
		\label{fig:nubeDiaEleccion} % Etiqueta para referencias cruzadas
	\end{figure}
	
	\vspace{-5mm}
	\begin{figure}[h!]
		\centering
		\includegraphics[width=1\textwidth]{nube_intervalo_8-12.pdf} % Cambia el tamaño con width o height
		\vspace{-22mm}
		\caption{Nube de Palabras en el Horario de 08:00 a 12:00}
		\label{fig:nubeIntervalo812} % Etiqueta para referencias cruzadas
	\end{figure}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=1\textwidth]{nube_intervalo_12-17.pdf} % Cambia el tamaño con width o height
		\vspace{-22mm}
		\caption{Nube de Palabras en el Horario de 12:00 a 17:00}
		\label{fig:nubeIntervalo1217} % Etiqueta para referencias cruzadas
	\end{figure}
	
	\vspace{-10mm}
	\begin{figure}[h!]
		\centering
		\includegraphics[width=1\textwidth]{nube_intervalo_17-23.pdf} % Cambia el tamaño con width o height
		\vspace{-22mm}
		\caption{Nube de Palabras en el Horario de 17:00 a 23:00}
		\label{fig:nubeIntervalo1723} % Etiqueta para referencias cruzadas
	\end{figure}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.8\textwidth]{longitud_comentarios_youtube.pdf} % Cambia el tamaño con width o height
		\vspace{-2mm}
		\caption{Distribución de Longitud de Comentarios en Youtube}
		\label{fig:longYoutube} % Etiqueta para referencias cruzadas
	\end{figure}
	
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.8\textwidth]{longitud_publicaciones_x.pdf} % Cambia el tamaño con width o height
		\vspace{-2mm}
		\caption{Distribución de Longitud de Publicaciones en X}
		\label{fig:longX} % Etiqueta para referencias cruzadas
	\end{figure}
