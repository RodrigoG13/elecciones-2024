...
\begin{document}
	...
	\begin{figure}[h!] % 'h!' posiciona la imagen cerca del texto relacionado
		\centering
		\includegraphics[width=0.75\textwidth]{sA_intervalo_0812.pdf} % Ajusta el tamaño con width o height
	...
	\begin{figure}[h!] % 'h!' posiciona la imagen cerca del texto relacionado
		\centering
		\includegraphics[width=0.75\textwidth]{sA_intervalo_1217.pdf} % Ajusta el tamaño con width o height
	...
	\begin{figure}[h!] % 'h!' posiciona la imagen cerca del texto relacionado
		\centering
		\includegraphics[width=0.75\textwidth]{sA_intervalo_1723.pdf} % Ajusta el tamaño con width o height
		\caption{Distribución de sentimientos en el horario 17:00 a 23:00} % Texto del caption
